...
if (runtime.render && !fs.existsSync(runtime.persistentRoot)) throw new Error('Disco persistente do Render ausente. Inicializacao cancelada para proteger os dados.');
