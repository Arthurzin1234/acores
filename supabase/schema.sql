...
alter table company_experience enable row level security;
alter table experience_migrations enable row level security;
alter table onboarding_profiles enable row level security;
alter table auth_sessions enable row level security;
alter table auth_bootstrap enable row level security;
alter table security_audit enable row level security;
alter table auth_legal_versions enable row level security;
alter table auth_legal_acceptance enable row level security;
...
alter table wa_runtime enable row level security;
alter table wa_human_inbox enable row level security;
alter table whatsapp_sent_ids enable row level security;
alter table whatsapp_human_pause enable row level security;
alter table whatsapp_human_seen enable row level security;
alter table whatsapp_chat_policy enable row level security;
alter table whatsapp_processed_messages enable row level security;
alter table whatsapp_chat_alias enable row level security;
alter table whatsapp_auth_meta enable row level security;
