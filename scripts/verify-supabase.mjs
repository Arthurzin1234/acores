...
const required = ['clients','tickets','messages','notifications','appointments','checklist_items','auth_users','auth_sessions','ai_settings','wa_inbox','wa_jobs','wa_outbox','conversation_memory'];
try {
